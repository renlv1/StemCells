<template>
    <div class="wrap preview-wrap">
        <div class="head">
            ...
            <div class="title">正文预览</div>
            <div class="btn theEditor" id="theEditor" @click="theEditor">编辑</div>
        </div>
        <div class="user">
        ...
        <div class="footer">
            <div class="button">
                <div class="btn goPelease" id="goPelease" @click="goEditor"><span>发布</span></div>
            </div>
        </div>
    </div>
</template>
